...
<head>
    ...
    <title>Farin Jakada | Admin Dashboard</title>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="<?= base_url('admin/') ?>"> <i class="menu-icon fa fa-home"></i>Home </a>
                    </li>
                    ...
                    <li class="">
                        <a href="<?= base_url('admin/logout') ?>"> <i class="menu-icon fa fa-sign-out"></i>Logout </a>
                    </li>
